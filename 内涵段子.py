...
def get_id(url,a):
    ...
    infos = selector.xpath('//div[@class="content-wrapper"]/a/div/p')
    for info in infos:
        try:
            ...
            sql11 = "INSERT INTO NEIHANDUANZI(content) \
                                           VALUES ('%s')" % \
                   (content)
            # # try:
    ...
    a = int(a) + 1
    url1 = 'http://neihanshequ.com?page=%s' % a
    get_id(url1,a)
    print '**********************************************' + a


if __name__ == '__main__':
    url = 'http://neihanshequ.com?page=1'
    a = 1
